...
<head>
    ...
    <head lang="es">
        ...
        <script src="https://kit.fontawesome.com/23dd7629a3.js" crossorigin="anonymous"></script>
...
<?php 
    $id = $_SESSION["id_presidente"];
    include_once("./../includes/conexion.php"); 
    
    $sql = $pdo->query("SELECT * FROM presidentes_mesa WHERE id_presidente = '$id'");
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h5 class="p-2 text-center bg-primary"><?=$datos ->nombre_presidente?></h5>

                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="./login.presidente">
